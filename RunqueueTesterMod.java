 ...
 */
public class RunqueueTesterMod {
    ...
    public static void usage(String progName) {
        ...
        System.out.println("OR with input: ");
        System.out.println(progName + ": <implementation> [filename of input commands]");
    ...
    public static void main(String[] args) {
        ...
        if (args.length >= 3) {
            ...
            // Interactive mode with file input, console output
            commandInputFilename = args[1];
            System.out.println("Running in Interative mode with input.");
        }
